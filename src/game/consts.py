...
LASER_GUN_COOLDOWN = 400
LASER_GUN_BULLET_WIDTH = BLOCK_SIZE / 3.5
LASER_GUN_BULLET_HEIGHT = BLOCK_SIZE / 5
LASER_GUN_BULLET_SPEED = (BLOCK_SIZE / 2) * OLD_FPS
LASER_GUN_BULLET_DAMAGE = 34

BAZOOKA_COOLDOWN = 1000
BAZOOKA_BULLET_WIDTH = BLOCK_SIZE / 2
BAZOOKA_BULLET_HEIGHT = BLOCK_SIZE / 3
BAZOOKA_BULLET_SPEED = (BLOCK_SIZE / 3.0) * OLD_FPS
BAZOOKA_BULLET_DAMAGE = 50

SHOTGUN_COOLDOWN = 600
SHOTGUN_BULLET_WIDTH = BLOCK_SIZE / 3
SHOTGUN_BULLET_HEIGHT = BLOCK_SIZE / 5
SHOTGUN_BULLET_SPEED = (BLOCK_SIZE / 1.5) * OLD_FPS
SHOTGUN_BULLET_DAMAGE = 50 / 3
